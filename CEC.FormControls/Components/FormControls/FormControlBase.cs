...
{
    /// <summary>
    ///  A base class that is a direct copy of the InputBase<TValue> base class
    ///  Except that CurrentValue is declared Virtual so that it can be overridden in inherited classes
    ///  This allow for custom handling on the update process and event triggers
    ///  These are implemented in the FormRecordInputBase class
    /// </summary>
    public abstract class FormControlBase<TValue> : ComponentBase, IDisposable
    {
        ...
        /// ******* MODIFICATION FROM INPUTBASE<TVALUE> - DECLARED AS VIRTUAL TO ALLOW OVERRIDING
        /// </summary>
